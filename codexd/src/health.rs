            ...
            move || {
                ...
                async move {
                    Json(json!({
                        ...
                        "runtimeMode": shared_state.runtime_supervisor.runtime_mode(),
                        "workspaceRoot": shared_state.runtime_supervisor.workspace_root(),
                        "configuredModel": shared_state.runtime_supervisor.configured_model(),
