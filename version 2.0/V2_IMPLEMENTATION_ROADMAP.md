...
Turn the V2 architecture into code without touching the current shipping path outside `version 2.0/`.
...
├── CodexMobile/              legacy snapshot
├── phodex-bridge/            legacy snapshot
├── relay/                    legacy snapshot
├── proto/                    new
├── codexd/                   new Rust daemon
├── codex-relay-rs/           new Rust relay
└── mobile-ios/               new iOS client worktree or migrated app source
```
...
1. create `version 2.0/proto/`
2. create `version 2.0/codex-relay-rs/`
3. create `version 2.0/codexd/`
